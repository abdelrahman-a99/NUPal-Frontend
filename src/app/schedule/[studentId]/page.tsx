    ...
    if (loading) {
        return (
            <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center gap-4">
                ...
                <p className="text-slate-500 font-medium">Loading secure public schedule...</p>
            </div>
        );
    }
        ...
        <div className="min-h-screen bg-slate-50 py-12 px-6">
            <div className="max-w-3xl mx-auto">
                ...
                <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-3xl p-8 mb-6 shadow-xl relative overflow-hidden">
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                        <div className="flex items-center gap-5">
                            <div className="w-20 h-20 rounded-2xl bg-white shadow-lg flex items-center justify-center flex-shrink-0">
                                <span className="text-3xl font-black text-blue-600">{studentName.charAt(0)}</span>
                            </div>
                            <div>
                ...
                <div className="bg-amber-50 border border-amber-200 rounded-2xl p-4 mb-8 flex items-start gap-3">
                    ...
                    <div>
                        <p className="text-sm font-bold text-amber-900">Privacy Protected View</p>
                        <p className="text-xs text-amber-700 mt-1">This is a public, read-only schedule link. Grades, GPA, and personal identification numbers are strictly hidden.</p>
                    </div>
                </div>
                        ...
                        <div key={idx} className="bg-white border border-slate-100 rounded-2xl p-5 shadow-sm hover:shadow-md transition-shadow">
                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                <div>
                                    ...
                                    <div className="flex flex-wrap items-center gap-4 text-sm text-slate-500 pl-5">
                                ...
                                <div className="bg-slate-50 rounded-xl p-3 md:min-w-[140px] border border-slate-100 pl-5 md:pl-3">
                                    <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-1">{course.day}</p>
