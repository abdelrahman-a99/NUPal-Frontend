        ...
        <div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5">
                    ...
                    <div className="flex items-center justify-center gap-1 bg-white rounded-2xl border border-slate-100 p-1.5 shadow-sm">
                        <button
                            className={`flex-1 sm:flex-initial px-4 py-2 rounded-xl transition-all flex justify-center ${viewMode === 'list' ? 'bg-[#2F80ED] text-white shadow-sm' : 'text-slate-500 hover:text-slate-800 hover:bg-slate-50'}`}
                            onClick={() => handleSetViewMode('list')}
                        >
                            <List size={18} strokeWidth={2} />
                        </button>
                        <button
                            className={`flex-1 sm:flex-initial px-4 py-2 rounded-xl transition-all flex justify-center ${viewMode === 'grid' ? 'bg-[#2F80ED] text-white shadow-sm' : 'text-slate-500 hover:text-slate-800 hover:bg-slate-50'}`}
